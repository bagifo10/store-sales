                ...
                if (docSnap.exists()) {
                    ...
                    if (prodData.category) {
                        ...
                        const similar = querySnapshot.docs
                            ...
                            .filter(p => p.id !== prodData.id); // exclude current product
                        setSimilarProducts(similar);
                    } else {
                        // Fallback: Just fetch any 4 products if no category is defined
            ...
            <div className="ml-container" style={{ marginTop: '20px' }}>
                ...
                <div style={{ background: '#fff', borderRadius: '8px', padding: '30px', display: 'flex', gap: '40px', boxShadow: '0 1px 2px rgba(0,0,0,0.1)', flexDirection: 'row', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ fontSize: '36px', fontWeight: 300, color: '#333', marginBottom: '20px' }}>
                            ${product.price}
                        </div>
                            ...
                            {similarProducts.map(sim => (
                                ...
                                >
                                    ...
                                    <div style={{ padding: '15px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                                        <div style={{ fontSize: '20px', fontWeight: 400, marginBottom: '5px', color: '#333' }}>${sim.price}</div>
